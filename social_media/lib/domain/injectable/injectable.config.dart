...
import '../../application/follow/follow_bloc.dart' as _i15;
import '../../application/home/home_feed_bloc.dart' as _i16;
import '../../application/others_profile/others_profile_bloc.dart' as _i17;
import '../../application/post_actions/post_actions_bloc.dart' as _i18;
import '../../application/post_crud/post_crud_bloc.dart' as _i19;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i15.FollowBloc>(() => _i15.FollowBloc(get<_i10.ProfileRepo>()));
  gh.factory<_i16.HomeFeedBloc>(() => _i16.HomeFeedBloc(get<_i6.HomeRepo>()));
  gh.factory<_i17.OthersProfileBloc>(
      () => _i17.OthersProfileBloc(get<_i10.ProfileRepo>()));
  gh.factory<_i18.PostActionsBloc>(
      () => _i18.PostActionsBloc(get<_i8.PostRepo>()));
  gh.factory<_i19.PostCrudBloc>(
      () => _i19.PostCrudBloc(get<_i10.ProfileRepo>()));
  gh.factory<_i20.ProfileBloc>(() => _i20.ProfileBloc(get<_i10.ProfileRepo>()));
  gh.factory<_i21.SearchBloc>(() => _i21.SearchBloc(get<_i12.SearchRepo>()));
  return get;
}
